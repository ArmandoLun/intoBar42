    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <script>
                    var carrusel = document.querySelector(".owl-carousel"), items = 25, HTML;
                    for(var x=0; x<items; x++){
                        ...
                        HTML += "<div><h4>Mesa 1 30/08 10:00</h4><div style='width: 20px;'></div>" +
                            "<button class='btn btn-primary btn-shadow btn-lg'>pagar</button></div><br>";
                    }
